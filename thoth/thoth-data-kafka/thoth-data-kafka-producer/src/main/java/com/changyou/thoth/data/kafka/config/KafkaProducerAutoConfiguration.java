...
public class KafkaProducerAutoConfiguration {
	...
	public KafkaProducerAutoConfiguration(KafkaProducerProperties kafkaProducerProperties) {
		logger.debug("KafkaProducerAutoConfiguration kafkaProducerProperties:{}",
				JSON.toJSONString(kafkaProducerProperties));
	...
	public Map<String, Object> producerConfigs() {
		...
		props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, kafkaProducerProperties.getBrokerAddress());
